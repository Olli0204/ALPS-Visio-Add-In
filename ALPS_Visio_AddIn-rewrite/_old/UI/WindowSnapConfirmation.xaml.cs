...
namespace VisioAddIn
{
    ...
    public partial class WindowSnapConfirmation : System.Windows.Window
    {
        ...
        public WindowSnapConfirmation(SnapHandler snapHandler, Shape snappingShape, Shape referenceBackgroundShape)
        {
            ...
            this.Title = ALPS_Visio_AddIn_rewrite.Resources.strings.WindowSnapConfirmationTitle;
            btnDialogYes.Content = ALPS_Visio_AddIn_rewrite.Resources.strings.Yes;
            btnDialogNo.Content = ALPS_Visio_AddIn_rewrite.Resources.strings.No;

            // Fills the two labels with the name of the shapes
            labelShapeSnapName.Content = string.Format(ALPS_Visio_AddIn_rewrite.Resources.strings.WindowSnapConfirmationShouldShapeSnap, "\"" + snappingShape.Name + "\"");
            labelShapeSnapToName.Content = string.Format(ALPS_Visio_AddIn_rewrite.Resources.strings.WindowSnapConfirmationShouldSnapTo, "\"" + referenceBackgroundShape.Name + "\"");
