...
namespace VisioAddIn
{
    ...
    public partial class WindowSnapMaintenance : System.Windows.Window
    {
            ...
            SnapHandler snapHandler, Shape shape, Shape snapToShape)
        {
            ...
            Title = ALPS_Visio_AddIn_rewrite.Resources.strings.WindowSnapConfirmationTitle;
            ...
            labelShapeSnapName.Content = string.Format(ALPS_Visio_AddIn_rewrite.Resources.strings.WindowSnapConfirmationShouldShapeSnap, "\"" + shape.Name + "\"");
            labelShapeSnapToName.Content = string.Format(ALPS_Visio_AddIn_rewrite.Resources.strings.WindowSnapMaintenanceShouldStaySnapped, "\"" + snapToShape.Name + "\"");
