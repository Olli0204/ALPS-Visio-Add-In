...
namespace VisioAddIn.Snapping
{
    ...
    public abstract class DiagramPageController
    {
        ...
        protected void setBackgroundForThis(string backgroundPageName)
        {
            ...
            foreach (var page in ALPS_Visio_AddIn_rewrite.Globals.ThisAddIn.Application.ActiveDocument.Pages.Cast<Page>().Where(page => page.NameU.Equals(backgroundPageName)))
            {
        ...
        {
            Documents visioDocs = ALPS_Visio_AddIn_rewrite.Globals.ThisAddIn.Application.Documents;
            Document visioStencil = visioDocs.OpenEx(ALPS_Visio_AddIn_rewrite.ShapeFinder.getSIDName(),
